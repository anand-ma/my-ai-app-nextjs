...
export const aiApps: AIApp[] = [
    ...
    {
        "name": "Code Explorer",
        "description": "Input link of a single code file and get explaination in simple english, code explanation and use cases",
    ...
    },
    {
        ...
        "description": " Analyzes images of product ingredients using various AI models",
        "url": "https://ingredient-analyzer-nextjs.vercel.app/"
    }
];